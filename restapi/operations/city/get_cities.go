...
type GetCitiesHandlerFunc func(GetCitiesParams) middleware.Responder

// Handle executing the request and returning a response
func (fn GetCitiesHandlerFunc) Handle(params GetCitiesParams) middleware.Responder {
	return fn(params)
}

// GetCitiesHandler interface for that can handle valid get cities params
type GetCitiesHandler interface {
	Handle(GetCitiesParams) middleware.Responder
}
...
/*GetCities swagger:route GET /cities City getCities
